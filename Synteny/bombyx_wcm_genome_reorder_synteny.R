...
######################################
library(ggplot2,plotly,ggpubr,tidyverse,rsvg,RIdeogram)

######################################
## DIRECTORIES AND FILE NAMES

DATADIR <- "/projectnb/mullenl/alqassar/synteny/RIdeogram/"
SYNTENYDATA <- "wcm_bombyx_satsuma_summary.chained.out"
KARYOTYPEDATA <- "karyotype_bombyx_wcm.txt"
...
## now need to fix the species_2 column because it had a comma we need to remove
for(i in 1:nrow(df_synteny)){
  df_synteny$Species_2[i] <-  strsplit(df_synteny$Species_2[i], ',')[[1]][1]}


#need to remove unmapped Bombyx scaffolds from dataframe 
df_synteny_chroms_only = df_synteny %>% 
  filter(!grepl('whole', Species_2))
...
df_synteny_ideogram = df_synteny_ideogram %>%
  mutate(fill=case_when(Species_1 == 1 & fill == '000000' ~ 'FF0000', Species_1 == 2 & fill == '000000' ~ 'FF8C00'
                        ...
                        ,Species_1 == 7 & fill == '000000' ~ 'FF69B4', Species_1 == 8 & fill == '000000' ~ 'F08080'
                        ,Species_1 == 9 & fill == '000000'~ 'FFA500', Species_1 == 10 & fill == '000000'~ '2E8B57'
                        ,Species_1 == 11 & fill == '000000'~ '473C8B', Species_1 == 12 & fill == '000000'~ '63B8FF'
                        ,Species_1 == 13 & fill == '000000'~ 'CD8500', Species_1 == 14 & fill == '000000'~ '8B2500'
                        ,Species_1 == 15 & fill == '000000'~ 'FF83FA' , Species_1 == 16 & fill == '000000'~ '98FB98'
                        ,Species_1 == 17 & fill == '000000'~ 'CDAF95', Species_1 == 18 & fill == '000000' ~ '8B2252'
                        ,Species_1 == 19 & fill == '000000' ~ '9ACD32',Species_1 == 20 & fill == '000000' ~ '63B8FF'  
                        ,Species_1 == 21 & fill == '000000'~ '7FFFD4', Species_1 == 22 & fill == '000000' ~'EE7621'
                        ,Species_1 == 23 & fill == '000000' ~ 'FF7256', Species_1 == 24 & fill == '000000' ~ '8B008B'
                        ,Species_1 == 25 & fill == '000000' ~ 'EE9A00', Species_1 == 27 & fill == '000000' ~ 'CD919E'
                        ,Species_1 == 28 & fill == '000000' ~ '551A8B', Species_1 == 29 & fill == '000000' ~ 'BC8F8F'
                        ,TRUE ~ 'cccccc'))
...
df_karyotype = df_karyotype %>%
  mutate(fill=case_when(Chr == 1 & species == 'T. bisselliella ' ~ 'FF0000', Chr == 2 & species == 'T. bisselliella ' ~ 'FF8C00'
                        ...
                        ,Chr == 7 & species == 'T. bisselliella ' ~ 'FF69B4', Chr == 8 & species == 'T. bisselliella ' ~ 'F08080'
                        ,Chr == 9 & species == 'T. bisselliella '~ 'FFA500', Chr == 10 & species == 'T. bisselliella '~ '2E8B57'
                        ,Chr == 11 & species == 'T. bisselliella '~ '473C8B', Chr == 12 & species == 'T. bisselliella '~ '63B8FF'
                        ,Chr == 13 & species == 'T. bisselliella '~ 'CD8500', Chr == 14 & species == 'T. bisselliella '~ '8B2500'
                        ,Chr == 15 & species == 'T. bisselliella '~ 'FF83FA' , Chr == 16 & species == 'T. bisselliella '~ '98FB98'
                        ,Chr == 17 & species == 'T. bisselliella '~ 'CDAF95', Chr == 18 & species == 'T. bisselliella ' ~ '8B2252'
                        ,Chr == 19 & species == 'T. bisselliella ' ~ '9ACD32', Chr == 20 & species == 'T. bisselliella ' ~ '63B8FF'  
                        ,Chr == 21 & species == 'T. bisselliella '~ '7FFFD4', Chr == 22 & species == 'T. bisselliella ' ~'EE7621'
                        ,Chr == 23 & species == 'T. bisselliella ' ~ 'FF7256', Chr == 24 & species == 'T. bisselliella ' ~ '8B008B'
                        ,Chr == 25 & species == 'T. bisselliella ' ~ 'EE9A00', Chr == 27 & species == 'T. bisselliella ' ~ 'CD919E'
                        ,Chr == 28 & species == 'T. bisselliella ' ~ '551A8B', Chr == 29 & species == 'T. bisselliella ' ~ 'BC8F8F'
                        ,TRUE ~ 'cccccc'))
...
ideogram(karyotype = df_karyotype, synteny = df_synteny_ideogram, output = "wcm_bombyx_Sep29_black.svg")
