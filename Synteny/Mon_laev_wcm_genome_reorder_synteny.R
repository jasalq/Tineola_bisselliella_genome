...
SYNTENYDATA <- "wcm_Mon_laev_satsuma_summary.chained.out"
KARYOTYPEDATA <- "karyotype_Mon_laev_wcm.txt"
...
df_karyotype$fill[df_karyotype$species=='Monopis_laevigella'] <- 'cccccc'
...
df_karyotype <- mutate_if(df_karyotype, 
  is.character, 
  str_replace_all, 
  pattern = "Monopis_laevigella", 
  replacement = "M. laevigella")
...
#need to remove unmapped Monopis scaffolds from dataframe 
...
df_synteny_ideogram = df_synteny_ideogram %>%
  mutate(fill=case_when(Species_1 == 1 & fill == '000000' ~ 'FF0000', Species_1 == 2 & fill == '000000' ~ 'FF8C00'
                        ...
                        ,Species_1 == 9 & fill == '000000'~ 'FFA500', Species_1 == 11 & fill == '000000'~ '2E8B57'
                        ...
                        ,Species_1 == 18 & fill == '000000'~ 'CDAF95', Species_1 == 19 & fill == '000000' ~ '8B2252'
                        ,Species_1 == 20 & fill == '000000' ~ '9ACD32',Species_1 == 21 & fill == '000000' ~ '63B8FF'  
                        ,Species_1 == 22 & fill == '000000'~ '7FFFD4', Species_1 == 23 & fill == '000000' ~'EE7621'
                        ,Species_1 == 24 & fill == '000000' ~ 'FF7256', Species_1 == 25 & fill == '000000' ~ '8B008B'
                        ,Species_1 == 26 & fill == '000000' ~ 'EE9A00', Species_1 == 27 & fill == '000000' ~ 'CD919E'
...
df_karyotype = df_karyotype %>%
  mutate(fill=case_when(Chr == 1 & species == 'T. bisselliella ' ~ 'FF0000', Chr == 2 & species == 'T. bisselliella ' ~ 'FF8C00'
                        ...
                        ,Chr == 9 & species == 'T. bisselliella '~ 'FFA500', Chr == 11 & species == 'T. bisselliella '~ '2E8B57'
                        ...
                        ,Chr == 18 & species == 'T. bisselliella '~ 'CDAF95', Chr == 19 & species == 'T. bisselliella ' ~ '8B2252'
                        ,Chr == 20 & species == 'T. bisselliella ' ~ '9ACD32', Chr == 21 & species == 'T. bisselliella ' ~ '63B8FF'  
                        ,Chr == 22 & species == 'T. bisselliella '~ '7FFFD4', Chr == 23 & species == 'T. bisselliella ' ~'EE7621'
                        ,Chr == 24 & species == 'T. bisselliella ' ~ 'FF7256', Chr == 25 & species == 'T. bisselliella ' ~ '8B008B'
                        ,Chr == 26 & species == 'T. bisselliella ' ~ 'EE9A00', Chr == 27 & species == 'T. bisselliella ' ~ 'CD919E'
...
ideogram(karyotype = df_karyotype, synteny = df_synteny_ideogram, output = "wcm_Mon_laev_Oct8_color.svg")
