...
SYNTENYDATA <- "wcm_Tin_trin_satsuma_summary.chained.out"
KARYOTYPEDATA <- "karyotype_Tin_trin_wcm.txt"
...
df_karyotype$fill[df_karyotype$species=='Tinea_trinotella'] <- 'cccccc'
...
df_karyotype <- mutate_if(df_karyotype, 
  is.character, 
  str_replace_all, 
  pattern = "Tinea_trinotella", 
  replacement = "T. trinotella")
...
ideogram(karyotype = df_karyotype, synteny = df_synteny_ideogram, output = "wcm_Tin_trin_Oct9_color.svg")
