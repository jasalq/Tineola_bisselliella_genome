...
setwd("/projectnb/mullenl/alqassar/synteny/RIdeogram/")
DATADIR <- "/projectnb/mullenl/alqassar/synteny/RIdeogram/"
SYNTENYDATA <- "wcm_Tin_semi_satsuma_summary.chained.out"
KARYOTYPEDATA <- "karyotype_Tin_semi_wcm.txt"
...
df_karyotype$fill[df_karyotype$species=='Tinea_semifulvella'] <- 'cccccc'
...
df_karyotype <- mutate_if(df_karyotype, 
                          is.character, 
                          str_replace_all, 
                          pattern = "Tinea_semifulvella", 
                          replacement = "T. semifulvella")
...
#need to remove unmapped scaffolds from dataframe 
#df_synteny_chroms_only = df_synteny %>% 
 # filter(!grepl('scaffold', Species_2))


df_synteny_ideogram = df_synteny %>%
...
#df_synteny_ideogram = df_synteny_ideogram %>%
  #mutate(fill=case_when(Species_1 == 1 & fill == '000000' ~ 'FF0000', Species_1 == 2 & fill == '000000' ~ 'FF8C00'
                        ...
                        ,Species_1 == 13 & fill == '000000'~ '473C8B', Species_1 == 14 & fill == '000000'~ '63B8FF'
                        ,Species_1 == 15 & fill == '000000'~ 'CD8500', Species_1 == 16 & fill == '000000'~ '8B2500'
                        ,Species_1 == 18 & fill == '000000'~ 'FF83FA' , Species_1 == 19 & fill == '000000'~ '98FB98'
                        ,Species_1 == 20 & fill == '000000'~ 'CDAF95', Species_1 == 21 & fill == '000000' ~ '8B2252'
                        ,Species_1 == 25 & fill == '000000' ~ '9ACD32',Species_1 == 26 & fill == '000000' ~ '63B8FF'  
                        ,Species_1 == 27 & fill == '000000'~ '7FFFD4', Species_1 == 28 & fill == '000000' ~'EE7621'
                        ,Species_1 == 29 & fill == '000000' ~ 'FF7256'
                        ,TRUE ~ 'cccccc'))
...
#df_karyotype = df_karyotype %>%
  #mutate(fill=case_when(Chr == 1 & species == 'T. bisselliella ' ~ 'FF0000', Chr == 2 & species == 'T. bisselliella ' ~ 'FF8C00'
                        ...
                        ,Chr == 13 & species == 'T. bisselliella '~ '473C8B', Chr == 14 & species == 'T. bisselliella '~ '63B8FF'
                        ,Chr == 15 & species == 'T. bisselliella '~ 'CD8500', Chr == 16 & species == 'T. bisselliella '~ '8B2500'
                        ,Chr == 18 & species == 'T. bisselliella '~ 'FF83FA' , Chr == 19 & species == 'T. bisselliella '~ '98FB98'
                        ,Chr == 20 & species == 'T. bisselliella '~ 'CDAF95', Chr == 21 & species == 'T. bisselliella ' ~ '8B2252'
                        ,Chr == 25 & species == 'T. bisselliella ' ~ '9ACD32', Chr == 26 & species == 'T. bisselliella ' ~ '63B8FF'  
                        ,Chr == 27 & species == 'T. bisselliella '~ '7FFFD4', Chr == 28 & species == 'T. bisselliella ' ~'EE7621'
                        ,Chr == 29 & species == 'T. bisselliella ' ~ 'FF7256'
                        ,TRUE ~ 'cccccc'))
...
ideogram(karyotype = df_karyotype, synteny = df_synteny_ideogram, output = "wcm_Tin_semi_Oct18.svg")
